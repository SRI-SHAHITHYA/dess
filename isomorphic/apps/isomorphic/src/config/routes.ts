export const routes = {
  edu: {
    ...
    signIn: '/edu/sign-in',
    signUp: '/edu/sign-up',
    learnCategories: '/edu/learn/categories',
    categories: '/edu/cat',
    createCategory: '/edu/cat/create',
    editCategory: (id: string) => `/edu/cat/${id}/edit`,
    category: '/edu/category',
    createCategoryNew: '/edu/category/create',
    editCategoryNew: (id: string) => `/edu/category/${id}/edit`,
    categoryTopics: (id: string) => `/edu/category/${id}/topics`,
    categorySubmodules: (id: string) => `/edu/category/${id}/submodules`,
    moduleTopics: (moduleId: string) => `/edu/module/${moduleId}/topics`,
    submoduleTopics: (submoduleId: string) => `/edu/submodule/${submoduleId}/topics`,
    modules: '/edu/module',
    createModule: '/edu/module/create',
    editModule: (id: string) => `/edu/module/${id}/edit`,
    topic: '/edu/topic',
    createTopic: '/edu/topic/create',
    editTopic: (id: string) => `/edu/topic/${id}/edit`,
    topics: '/edu/topics',
    createTopics: '/edu/topics/create',
    editTopics: (id: string) => `/edu/topics/${id}/edit`,
  },
  eCommerce: {
    dashboard: '/ecommerce',
