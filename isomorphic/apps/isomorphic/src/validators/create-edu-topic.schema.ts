...
export const eduTopicFormSchema = z.object({
  module_id: z.number().or(z.string()).optional(),
  submodule_id: z.number().or(z.string()).optional(),
...
export type EduTopicFormInput = z.infer<typeof eduTopicFormSchema>;
