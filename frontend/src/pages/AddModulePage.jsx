...
export default function AddModulePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (showSeoSection && result.module_id) {
        const pageId = `module-${result.module_id}`;
  ...
  const goBack = () => {
    navigate(`/category/${categoryId}/modules`, {
      state: { category }
    });
  };
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-bold text-gray-900">Create A Module</h1>
            <button
              onClick={goBack}
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="grid grid-cols-1 gap-8 divide-y divide-dashed divide-gray-200">
                ...
                >
                  ...
                  {/* Module Image */}
                  <div className="col-span-2">
                    <h3 className="text-base font-semibold text-gray-900 mb-1">Upload new module image</h3>
                  ...
                  >
                    ...
                    <div className="col-span-2 space-y-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Page URL (optional)
                          <span className="text-gray-500 text-xs ml-2">Canonical URL for this module</span>
                        </label>
                        <input
                          type="text"
                          value={pageUrl}
