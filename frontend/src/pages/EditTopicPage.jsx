...
export default function EditTopicPage() {
  ...
  const [topic] = useState(location.state?.topic || null);
  ...
  const handleSubmit = async (e) => {
    ...
    setIsUploading(true);
    try {
      // Upload new topic image if selected
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          <div className="text-sm text-gray-500">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900">Edit {topic?.name || 'Topic'}</span>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="grid grid-cols-1 gap-8 divide-y divide-dashed divide-gray-200">
                <HorizontalFormBlockWrapper
                  title="Edit topic:"
                  description="Edit the topic details"
                  isModalView={true}
                ...
                >
                    ...
                    <div className="col-span-2">
                      <QuillEditor
                        ...
                        onChange={setContent}
                        label="Content"
                        placeholder="Enter topic content (supports markdown)"
                        disabled={isLoading}
                      />
                    </div>

                    <div className="col-span-2">
                      <h3 className="text-base font-semibold text-gray-900 mb-1">Upload topic image</h3>
